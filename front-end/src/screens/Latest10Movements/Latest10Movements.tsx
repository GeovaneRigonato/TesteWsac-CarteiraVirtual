...
function Latest10Movements() {
  ...
  // Função para filtrar os movimentos com base na categoria e no tipo selecionados
  useEffect(() => {
  ...
  // Extract the values and dates from the filtered movements
  ...
  // Função para lidar com a mudança no tipo de movimentação selecionado
